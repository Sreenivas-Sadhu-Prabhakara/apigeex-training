...
COURSE_PATH   = 'fapi-30-day'
COURSE_NAME   = '30-Day Apigee X: Open Banking & FAPI'
OG_IMAGE      = 'og-fapi.png'
WORKLOAD      = 'PT30H'
INDEX_DESC    = 'Master Apigee X API proxy development for UK Open Banking and the FAPI security profile over 30 hands-on days: OAuth2, OIDC, mTLS, JWS/JWT and consent.'
BASE_KEYWORDS = ['apigee x', 'open banking', 'fapi', 'api proxy', 'oauth2', 'api security']
LEVEL         = ['Intermediate', 'Advanced']
BRAND         = 'Apigee X'
TITLE_OVERRIDES = {'day-07.html': 'Day 07: Message mediation & flow variables'}     # output filename -> hand-shortened <title>
